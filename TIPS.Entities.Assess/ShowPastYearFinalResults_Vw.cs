...
{
    [DataContract]
    public class ShowPastYearFinalResults_Vw
    {
        [DataMember]
        ...
        [DataMember]
        public virtual string EngSemIII { get; set; }
        [DataMember]
        ...
        [DataMember]
        public virtual string LangSemIII { get; set; }
        [DataMember]
        ...
        [DataMember]
        public virtual string HcSemIII { get; set; }
        [DataMember]
        ...
        [DataMember]
        public virtual string MathsSemIII { get; set; }
        [DataMember]
        ...
        [DataMember]
        public virtual string BioSemIII { get; set; }
        [DataMember]
        ...
        [DataMember]
        public virtual string PhySemIII { get; set; }
        [DataMember]
        ...
        [DataMember]
        public virtual string CheSemIII { get; set; }
        [DataMember]
        ...
        [DataMember]
        public virtual string IctSemIII { get; set; }
        [DataMember]
        ...
        [DataMember]
        public virtual string EcoSemIII { get; set; }
        [DataMember]
        ...
        [DataMember]
        public virtual string PhyEduSemIII { get; set; }
        [DataMember]
        ...
        public virtual string CombSemIII { get; set; }
        [DataMember]
