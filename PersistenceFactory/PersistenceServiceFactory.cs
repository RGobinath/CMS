...
{
    public class PersistenceServiceFactory : IDisposable
    {
        #region Properties
            ...
            using (ISession session = sessionFactory.OpenSession())
            {
                using (session.BeginTransaction())
                {
                    ...
                    IQuery query = session.GetNamedQuery(namedQuery)
                        .SetParameter("quotationId", value)
                        //.SetInt64(column, Convert.ToInt64(value))
        ...
        public T Get<T>(string column1, long value1, string column2, long value2, string column3, string value3)
        {
            try
            {
                using (ISession session = sessionFactory.OpenSession())
        ...
        ////Added By Prabakaran
        //public T Get<T>(string column1, string value1, string column2, string value2, string column3, string value3,string column4,string value4 )
        //{
        //    try
        //    {
        //        using (ISession session = sessionFactory.OpenSession())
        ...
        //                _criteriaGroup.Add(Restrictions.Eq(column2, value2));
        //                _criteriaGroup.Add(Restrictions.Eq(column3, value3));
        //                _criteriaGroup.Add(Restrictions.Eq(column4, value4));
        //                T item = _criteriaGroup.List<T>().FirstOrDefault<T>();
        //                return item;
        //            }
        //        }
                        ...
                        if (searchCriteria != null)
                        {
                            if (searchCriteria.Count > 0)
                            {
                                foreach (KeyValuePair<string, object> keyValuePair in searchCriteria.Where(x => x.Value != null))
                                {
                                    ...
                                    //Added by Gobi to search the decimal
                                    else if (keyValuePair.Value.GetType() == typeof(decimal))
                                    {
                                        criteria.Add(Expression.Eq(keyValuePair.Key.ToString(), keyValuePair.Value).IgnoreCase());
                                    }
                            ...
                            if (searchCriteria.Count > 0)
                            {
                                foreach (KeyValuePair<string, object> keyValuePair in searchCriteria.Where(x => x.Value != null))
                                {
                                    ...
                                    else if (keyValuePair.Value.GetType() == typeof(string[]))
                                    {
                                        ...
                                        // criteria.Add(Expression.And(keyValuePair.Key.ToString(), arr)); // tried by Anbu
                                        //criteria.Add(Expression.InsensitiveLikee(keyValuePair.Ky.ToString(), sPercentage + keyValuePair.Value.ToString().Trim() + sPercentage));
                                    }
                            ...
                            if (searchCriteria.Count > 0)
                            {
                                foreach (KeyValuePair<string, object> keyValuePair in searchCriteria.Where(x => x.Value != null))
                                {
                                    if (keyValuePair.Value.GetType() == typeof(string))
                                    {
                                        ...
                                        // criteria.Add(Expression.And(keyValuePair.Key.ToString(), keyValuePair.Value)); // tried by Anbu
                                        //  criteria.Add(Expression.InsensitiveLike(keyValuePair.Key.ToString(), keyValuePair.Value.ToString().Trim()));
        ...
        #region Added by deso
        public Dictionary<long, IList<T>> GetListWithExactSearchArrayCriteriaCount<T>(int? page, int? pageSize, string sortBy, string sortType, Dictionary<string, object> searchCriteria)
        {
            try
            {
                Dictionary<long, IList<T>> ListWithCount = new Dictionary<long, IList<T>>();
        ...
        #region added by micheal LIKE and Exact search in single
        ...
        //Added By Gobi For TransportManagement Toolbar search
        public Dictionary<long, IList<T>> GetListWithExactAndLikeSearchCriteriaWithCountWithDecimal<T>(int? page, int? pageSize, string sortType, string sortBy, Dictionary<string, object> exactSearchCriteria, Dictionary<string, object> likeSearchCriteria)
        {
            try
            {
                Dictionary<long, IList<T>> ListWithCount = new Dictionary<long, IList<T>>();
        ...
        //Added by kingston for QA (Criteria => ExactSearchCriteria,LikesearchCriteria,lon array)
        public Dictionary<long, IList<T>> GetListWithExactAndLikeSearchCriteriaWithCountWithLongArray<T>(int? page, int? pageSize, string sortType, string sortBy, Dictionary<string, object> exactSearchCriteria, Dictionary<string, object> likeSearchCriteria)
        {
            try
            {
                Dictionary<long, IList<T>> ListWithCount = new Dictionary<long, IList<T>>();
        ...
        public T Get<T>(string name, Int32 value)
        {
            try
            {
                using (ISession session = sessionFactory.OpenSession())
        ...
        public T Get<T>(string column1, long value1, string column2, bool value2)
        {
            try
            {
                using (ISession session = sessionFactory.OpenSession())
        ...
        #endregion
        #region Optional Parameters Added by Prabaharan
        public static IQuery AddStoredProcedureOptionalParameters(IQuery query, IEnumerable<SqlParameter> parameters)
        {
            foreach (var parameter in parameters)
            {
        ...
        public Dictionary<long, IList<T>> ExecuteStoredProcedurewithOptionalParametersByDictonary<T>(string procedureName, IList<SqlParameter> parameters)
        {
            IEnumerable<T> result;
            IList<T> TempList;
            Dictionary<long, IList<T>> DicResult = new Dictionary<long, IList<T>>();
            ...
            using (ISession session = sessionFactory.OpenSession())
            {
                ...
                {
                    var query = session.GetNamedQuery(procedureName);
                    AddStoredProcedureOptionalParameters(query, parameters);
                    result = query.List<T>();
                    TempList = result.Take(result.Count()).ToList();
                    DicResult.Add(TempList.Count(), TempList);
                    //session.Transaction.Commit();
        ...
        public T Get<T>(string column1, long value1, string column2, DateTime value2)
        {
            try
            {
                using (ISession session = sessionFactory.OpenSession())
        ...
        #endregion
        #region Added By Prabakaran
        public T Get<T>(string column1, long value1, string column2, string value2, string column3, DateTime value3)
        {
            try
            {
                using (ISession session = sessionFactory.OpenSession())
        ...
        public T Get<T>(string column1, string value1, string column2, string value2, string column3, string value3, string column4, string value4, string column5, string value5, string column6, string value6)
        {
            try
            {
                using (ISession session = sessionFactory.OpenSession())
                {
                    using (session.BeginTransaction())
                    {
                        ...
                        _criteriaGroup.Add(Restrictions.Eq(column3, value3));
                        _criteriaGroup.Add(Restrictions.Eq(column4, value4));
                        _criteriaGroup.Add(Restrictions.Eq(column5, value5));
                        _criteriaGroup.Add(Restrictions.Eq(column6, value6));
                        T item = _criteriaGroup.List<T>().FirstOrDefault<T>();
                        return item;
                    }
                }
        ...
        // Added by Gobinath on 24/05/2017
        public T Get<T>(string column1, string value1, string column2, string value2, string column3, string value3, string column4, string value4)
        {
            try
            {
        ...
        public T Get<T>(string column1, string value1, string column2, long value2, string column3, long value3,string column4,bool value4)
        {
            try
            {
                using (ISession session = sessionFactory.OpenSession())
        ...
        #endregion
        #region added by john naveen
        public T Get<T>(string column1, long value1, string column2, long value2, string column3, long value3, string column4, string value4)
        {
            try
            {
                using (ISession session = sessionFactory.OpenSession())
        ...
        public T Get<T>(string column1, string value1, string column2, string value2, string column3, string value3, string column4, bool value4)
        {
            try
            {
                using (ISession session = sessionFactory.OpenSession())
        ...
        #endregion
        public T Get<T>(string column1, long value1, string column2, long value2, string column3, string value3, string column4, string value4)
        {
            try
            {
                using (ISession session = sessionFactory.OpenSession())
        ...
        #region Added by JOHN NAVEEN
        public T Get<T>(string column1, long value1, string column2, long value2, string column3, long value3, string column4, bool value4)
        {
            try
            {
                using (ISession session = sessionFactory.OpenSession())
        ...
        #endregion
        public T Get<T>(string column1, Int32 value1, string column2, string value2)
        {
            try
            {
                using (ISession session = sessionFactory.OpenSession())
