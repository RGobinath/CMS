...
$(function () {
    ...
    var grid_selector = "#NotEnteredList";
    var pager_selector = "#NotEnteredListPager";
    ...
    datatype: 'local',
    type: 'GET',
    colNames: ['Name', 'Campus', 'Grade', 'Section'],
    colModel: [
    ...
    height: 250,
    viewrecords: true,
    caption: '<i class="fa fa-th-list">&nbsp;</i>Not Entered List Report',
