$(function () {
    ...
    $("#ddlAcademic").val($('#Year').val());
    $(grid_selector).jqGrid({
        url: "/Assess360/ReportCardRequestJqGridNew",
        datatype: 'json',
        type: 'GET',
        colNames: ['Id', 'RequestNo', 'Campus', 'Grade', 'Section', 'Group Name','AcademicYear', 'Created By', 'Created Date', 'ModifiedBy', 'ModifiedDate', ''],
        colModel: [
                      ...
                      { name: 'GroupName', index: 'GroupName', sortable: true },
    ...
    $('#saveRequest').click(function () {
        ...
        if (campus == "") { ErrMsg("Please fill the Campus"); return false; }
            ...
            $.ajax({
                ...
                async: false,
                dataType: "json",
                url: '/Assess360/CreateReportCardRequestNew?Campus=' + campus + '&Grade=' + grade + '&Section=' + section + '&AcYear=' + ayear + '&group=' + group,
...
function ShowReportRequest(Id) {
    window.location.href = "/Assess360/ReportCardCBSENew?RptRequestId=" + Id;
}