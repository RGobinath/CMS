$(function () {
    ...
    $(grid_selector).jqGrid({
        mtype: 'GET',
        url: '/Admission/TCRequestListJqGrid?Status=InProgress',
        datatype: 'json',
        height: '250',
        autowidth: true,
        shrinkToFit: true,
        colNames: ['Id', 'PreRegNum', 'Name', 'Campus', 'Grade', 'Id No', 'Academic Year', 'Status', 'Created By', '', 'Date Created'],
    ...
    $('#btnSearch').click(function () {
        ...
        LoadSetGridParam($(grid_selector), "/Admission/TCRequestListJqGrid?name=" + name + '&campus=' + Campus + '&status=' + status + '&grade=' + grade );
