$(function () {
    ...
    if ($("#UpdateSuccessMsg").val() != null & $("#UpdateSuccessMsg").val() != "") {
        ...
        InfoMsg("Notification Updated Successfully.", function () { $("#UpdateSuccessMsg").val(""); });
    }
    ...
    $("#file2").click(function () {
        ...
        if (ddlBranchCode == "" || ddlBranchCode == null || txtTopic == "" || txtTopic == null || txtPublishDate == "" || txtPublishDate == null || txtExpireDate == "" || txtExpireDate == null || ddlPublishTo == "" || ddlPublishTo == null) {
    ...
    $("#Submit").click(function () {
        ...
        if (ddlBranchCode == "" || ddlBranchCode == null || txtTopic == "" || txtTopic == null || txtPublishDate == "" || txtPublishDate == null || txtExpireDate == "" || txtExpireDate == null || ddlPublishTo == "" || ddlPublishTo == null || $('#AcademicYear').val() == "") {
            ErrMsg("Please Fill Required Notification Details.");
            return false;
        }
    });
...
function uploaddat(id1) {
    ...
    window.location.href = "/Notify/uploaddisplay?Id=" + id1;
     ...
     function (fillcampus) {
         ...
         ddlcam.append($('<option/>',
        {
         ...
         bkLib.onDomLoaded(function () {
             nicEditors.allTextAreas({ maxHeight: 80, fullPanel: true });
         });
