jQuery(function ($) {
    ...
    jQuery(grid_selector).jqGrid({
        ...
        colModel: [{ name: 'Id', index: 'Id', key: true, hidden: true },
                  ...
                  { name: 'Campus', index: 'Campus', search: true, editable: true, editoptions: { class: 'NoBorder' } },
                  { name: 'UserType', index: 'UserType' },
                  { name: 'EmailId', index: 'EmailId', search: true, editable: true, editoptions: { class: 'NoBorder' } },
                  { name: 'IsActive', index: 'IsActive', search: true, editable: true, edittype: 'select', editoptions: { value: "True:Yes;False:No;" }, stype: 'select', searchoptions: { sopt: ["eq", "ne"], value: ":True:Yes;False:No;" } },
        ...
        viewrecords: true,
        altRows: true,
        editurl: '/Account/DeactivateUser',
        multiselect: true,
        multiboxonly: true,
