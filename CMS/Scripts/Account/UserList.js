jQuery(function ($) {
    ...
    $(grid_selector).jqGrid({
        url: '/Account/UserListJQGrid',
        postData: { UserId: UserId, UserName: UserName, UserType: UserType, EmailId: EmailId },
        datatype: 'json',
        type: 'GET',
        colNames: ['User Id', 'User Name', 'User Type', 'Email Id', 'Password', 'Is Active'],
        colModel: [
        ...
        onSelectRow: function (rowid) {
            if (rowid == null) {
                ids = 0;
                ul = jQuery(grid_selector).jqGrid('getRowData', rowid);
    ...
    $("#Search").click(function () {
        ...
        var UserType = $("#txtUserType").val();
        var EmailId = $("#txtEmailId").val();
        var brUrl1 = '/Account/UserListJqGrid/?UserId=' + UserId + '&UserName=' + UserName + '&UserType=' + UserType + '&EmailId=' + EmailId;
        LoadSetGridParam($(grid_selector), brUrl1);
    });
