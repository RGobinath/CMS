jQuery(function ($) {
    ...
    jQuery(grid_selector).jqGrid({
        ...
        datatype: 'json',
        height: 200,
        colNames: ['Id', 'Campus', 'Vehicle Type', 'Type', 'Vehicle No', 'Fuel Type', 'Purpose'],
        colModel: [
                ...
                { name: 'Purpose', index: 'Purpose', width: 150, align: 'left',hidden:true }
                ],
        viewrecords: true,
        rowNum: 10,
        rowList: [10, 20, 30],
    ...
    function formateadorLink(cellvalue, options, rowObject) {
        ...
        return "<a style='color:#034af3;text-decoration:underline' href=/Transport/TransportDetails?VehicleId=" + rowObject[0] + ">" + cellvalue + "</a>";
    }
    //navButtons
        ...
        $(grid_selector).setGridParam(
                {
                    datatype: "json",
                    url: '/Transport/VehicleSubTypeMasterListJqGrid',
                    postData: { VehicleType: $("#VehicleType").val(), Type: $("#Type").val(), VehicleNo: $("#VehicleNo").val(), FuelType: $("#FuelType").val(), Campus: $("#branchcodeddl").val(), Purpose: $("#Purpose").val() },
                    page: 1
                }).trigger("reloadGrid");
    });
