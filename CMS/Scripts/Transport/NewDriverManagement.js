jQuery(function ($) {
    ...
    jQuery(grid_selector).jqGrid({
        url: '/Transport/DriverManagementListGrid?PageName=New',
        //postData: { userid: usersrch, appcd: appcdsrch, rlcd: rlcdsrch, depcd: depcdsrch, brncd: brncdsrch },
        datatype: 'json',
        height: 200,
        colNames: ['Id', 'Campus', 'Name', 'Driver Id No', 'Dob', 'Age', 'Gender', 'Contact No', 'Status', 'Created Date', 'Created By', 'Modified Date', 'Modified By'],
        colModel: [
...
//            window.open("DriverMasterJqGrid?PageName=New" + '&Campus=' + $("#txtDrvrCampus").val() + '&Name=' + $("#txtDrvrName").val()
...
//    });
    $('#btnnew').click(function () {
        window.location.href = '/Transport/DriverRegistrationForm';
    });
