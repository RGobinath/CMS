$(function () {
    ...
    var grid_selector = "#DriverAttendanceDetailsList";
    var pager_selector = "#DriverAttendanceDetailsListPager";
    ...
    jQuery(grid_selector).jqGrid({
        url: '/Transport/DriverAttendanceDetailsListJqGrid',
        datatype: 'json',
        height: 215,
        colNames: ['Id', 'Campus', 'Driver Name', 'Driver Id No', 'Absent Date', 'Absent Type', 'Created Date', 'Created By'],
        colModel: [
        ...
        caption: "<i class='ace-icon fa fa-user'></i>&nbsp;Driver Attendance Details List"
    ...
    jQuery(grid_selector).jqGrid('navGrid', pager_selector,
            ...
            }, {}, { width: 'auto', url: '/Transport/DeleteDriverAttendanceDetails/' }, {})
    ...
    if ($("#SuccessMsg").val() != null && $("#SuccessMsg").val() == "Yes") {
        ...
        ErrMsg("Attendance Details already entered for this Driver");
    }
    else { }
