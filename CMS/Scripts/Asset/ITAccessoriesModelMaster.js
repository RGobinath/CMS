...
jQuery(function ($) {
    ...
    jQuery(grid_selector).jqGrid({
        url: '/Asset/ITAccessoriesModelMasterJqGrid',
        datatype: 'json',
        height: 200,
        mtype: 'GET',
        colNames: ['Id', 'Brand', 'Model', 'Is Active', 'Created By', 'Created Date', 'Modified By', 'Modified Date'],
        colModel: [
                      ...
                      //},
                      { name: 'ITAccessoriesBrandMaster.Id', index: 'ITAccessoriesBrandMaster.Id', editable: true, editrules: { required: true }, edittype: 'select', editoptions: { dataUrl: '/Asset/GetITAccessoriesBrandNameddl', style: "width: 149px; height: 20px; font-size: 0.9em" } },
        ...
        caption: "<i class='ace-icon fa fa-list'></i>&nbsp;IT Accessories Model Master",
    })
    ...
    jQuery(grid_selector).jqGrid('navGrid', pager_selector,
            ...
            {
                width: 'auto', url: '/Asset/EditITAccessoriesModelMaster', modal: false, closeAfterEdit: true
            ...
            {
                width: 'auto', url: '/Asset/AddITAccessoriesModelMaster', modal: false, closeAfterAdd: true
                //url: '/Common/AddAcademicMaster', closeOnEscape: true, beforeShowForm: function (frm)
                //{ $('#FormCode').attr('readonly', 'readonly'); }
            }, //Add
              {
                  width: 'auto', url: '/Asset/DeleteITAccessoriesModelMaster', beforeShowForm: function (params) {
