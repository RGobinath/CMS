function FillProductNameDll() {
    $.getJSON("/Asset/GetAssetProductName",
      function (fillbc) {
          var ddlbc = $("#ddlProductName");
          ddlbc.empty();
...
jQuery(function ($) {
    ...
    jQuery(grid_selector).jqGrid({
        url: '/Asset/AssetProductTypeMasterJqGrid',
        datatype: 'json',
        height: 200,
        mtype: 'GET',
        colNames: ['AssetProductTypeMasterId', 'ProductName', 'ProductType', 'Is Active', 'Created By', 'Created Date', 'Modified By', 'Modified Date'],
        colModel: [
                      { name: 'AssetProductTypeMasterId', index: 'AssetProductTypeMasterId', hidden: true, editable: true, key: true },
                      //{
                      ...
                      //},
                      { name: 'AssetProductMaster.AssetProductMasterId', index: 'AssetProductMaster.AssetProductMasterId', editable: true, editrules: { required: true }, edittype: 'select', editoptions: { dataUrl: '/Asset/GetAssetProductNameddl', style: "width: 149px; height: 20px; font-size: 0.9em" } },
                      { name: 'ProductType', index: 'ProductType', editable: true, editrules: { required: true } },
        ...
        altRows: true,
        sortname: 'AssetProductTypeMasterId',
        sortorder: 'Asc',
        multiselect: true,
        multiboxonly: true,
        ...
        caption: "<i class='ace-icon fa fa-list'></i>&nbsp;Asset Product Type Master",
    })
    ...
    jQuery(grid_selector).jqGrid('navGrid', pager_selector,
            ...
            {
                width: 'auto', url: '/Asset/EditAssetProductTypeMaster', modal: false, closeAfterEdit: true
            ...
            {
                width: 'auto', url: '/Asset/AddAssetProductTypeMaster', modal: false, closeAfterAdd: true
                //url: '/Common/AddAcademicMaster', closeOnEscape: true, beforeShowForm: function (frm)
                //{ $('#FormCode').attr('readonly', 'readonly'); }
            }, //Add
              {
                  width: 'auto', url: '/Asset/DeleteAssetProductTypeMaster', beforeShowForm: function (params) {
    ...
    $("#btnReset").click(function () {
        ...
        jQuery(grid_selector).setGridParam(
       {
           datatype: "json",
           url: '/Asset/AssetProductTypeMasterJqGrid',
           postData: { ProductName: "", ProductType: "", IsActive: "" },
           page: 1
       }).trigger("reloadGrid");
    });
    $("#btnSearch").click(function () {
        ...
        jQuery(grid_selector).setGridParam(
       {
           datatype: "json",
           url: '/Asset/AssetProductTypeMasterJqGrid',
           postData: { ProductName: ProductName, ProductType: ProductType, IsActive: IsActive },
           page: 1
       }).trigger("reloadGrid");
    });
