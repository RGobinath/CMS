jQuery(function ($) {
    ...
    jQuery(grid_selector).jqGrid({
        url: '/Asset/AssetBrandMasterJqGrid',
        datatype: 'json',
        height: 200,
        mtype: 'GET',
        colNames: ['BrnadMasterId', 'Brand', 'Is Active', 'Created By', 'Created Date', 'Modified By', 'Modified Date'],
        colModel: [
                      { name: 'BrandMasterId', index: 'BrandMasterId', hidden: true, editable: true, key: true },
                      //{
                      ...
                      //},
                      {
                          name: 'Brand', index: 'Brand', editable: true, editrules: { required: true } 
        ...
        caption: "<i class='ace-icon fa fa-list'></i>&nbsp;Asset Brand Master",
    })
    ...
    jQuery(grid_selector).jqGrid('navGrid', pager_selector,
            ...
            {
                width: 'auto', url: '/Asset/EditAssetBrandMaster', modal: true, closeAfterEdit: true
            ...
            {
                width: 'auto', url: '/Asset/AddAssetBrandMaster', modal: true, closeAfterAdd: true
...
//        return [true];
//    } else {
//        return [false, column + ":Alphabets Only Allowed"];                
//    }
//}