jQuery(function ($) {
    ...
    jQuery(grid_selector).jqGrid({
        url: '/Asset/ITAccessoriesBrandMasterJqGrid',
        datatype: 'json',
        height: 200,
        mtype: 'GET',
        colNames: ['Id', 'Brand', 'Is Active', 'Created By', 'Created Date', 'Modified By', 'Modified Date'],
        colModel: [
        ...
        caption: "<i class='ace-icon fa fa-list'></i>&nbsp;IT Accessories Brand Master",
    })
    ...
    jQuery(grid_selector).jqGrid('navGrid', pager_selector,
            ...
            {
                width: 'auto', url: '/Asset/EditITAccessoriesBrandMaster', modal: true, closeAfterEdit: true
            ...
            {
                width: 'auto', url: '/Asset/AddITAccessoriesBrandMaster', modal: true, closeAfterAdd: true
                //url: '/Common/AddAcademicMaster', closeOnEscape: true, beforeShowForm: function (frm)
                //{ $('#FormCode').attr('readonly', 'readonly'); }
            }, //Add
              {
                  width: 'auto', url: '/Asset/DeleteITAccessoriesBrandMaster', beforeShowForm: function (params) {
