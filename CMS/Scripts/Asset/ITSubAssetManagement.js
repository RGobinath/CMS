...
jQuery(function ($) {
    ...
    $("#btnSearch").click(function () {
        ...
        $(grid_selector).setGridParam(
       {
           datatype: "json",
           url: '/Asset/ITSubAssetManagementjqGrid',
           postData: { AssetCode: AssetCode, AssetType: AssetType, Make: Make, Model: Model, SerialNo: SerialNumber, CurrentLocation: Location, FormId: FormId, CurrentBlock: Block, TransactionType: TransactionType, UserType: UserType },
           page: 1
       }).trigger("reloadGrid");
    });
