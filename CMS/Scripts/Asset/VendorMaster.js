...
jQuery(function ($) {
    ...
    jQuery(grid_selector).jqGrid({
        url: '/Asset/VendorMasterJqGrid',
        datatype: 'json',
        height: 200,
        mtype: 'GET',
        colNames: ['VendorId', 'Vendor Code', 'Vendor', 'Vendor Type', 'Is Active', 'Created By', 'Created Date', 'Modified By', 'Modified Date'],
        colModel: [
                      { name: 'VendorId', index: 'VendorId', hidden: true, editable: true, key: true },
                      ...
                      //},
                      { name: 'VendorName', index: 'VendorName', editable: true, editrules: { required: true } },
                      { name: 'VendorType', index: 'VendorType', editable: true, edittype: 'select', editoptions: { sopt: ['eq'], value: { '': 'Select', 'Purchase': 'Purchase', 'Service': 'Service', 'Both': 'Both' }, style: "width: 149px; height: 20px; font-size: 0.9em" }, editrules: { required: true } },
        ...
        caption: "<i class='ace-icon fa fa-list'></i>&nbsp;Vendor Master",
    })
    ...
    jQuery(grid_selector).jqGrid('navGrid', pager_selector,
            ...
            {
                width: 'auto', url: '/Asset/EditVendorMaster', modal: false, width: 250, height: 190, closeAfterEdit: true
            ...
            {
                width: 'auto', url: '/Asset/AddVendorMaster', modal: false, width: 250, height: 190, closeAfterAdd: true
                //url: '/Common/AddAcademicMaster', closeOnEscape: true, beforeShowForm: function (frm)
                //{ $('#FormCode').attr('readonly', 'readonly'); }
            }, //Add
              {
                  width: 'auto', url: '/Asset/DeleteVendorMaster', beforeShowForm: function (params) {
    ...
    $("#btnReset").click(function () {
        ...
        jQuery(grid_selector).setGridParam(
       {
           datatype: "json",
           url: '/Asset/VendorMasterJqGrid',
           postData: { VendorName: "", VendorType: "", IsActive: "" },
           page: 1
       }).trigger("reloadGrid");
    });
    $("#btnSearch").click(function () {
        var VendorName = $("#txtVendorName").val();
        var VendorType = $("#txtVendorType").val();
        var IsActive = $("#ddlIsActive").val();
        jQuery(grid_selector).setGridParam(
       {
           datatype: "json",
           url: '/Asset/VendorMasterJqGrid',
           postData: { VendorName: VendorName, VendorType: VendorType, IsActive: IsActive },
           page: 1
       }).trigger("reloadGrid");
    });
