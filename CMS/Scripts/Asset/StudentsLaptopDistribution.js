...
jQuery(function ($) {
    ...
    jQuery(grid_selector).jqGrid({
        url: '/Asset/StudentsLaptopDistributionjqGrid?IsSubAsset=false',
        datatype: 'json',
        height: 200,
        mtype: 'GET',
        colNames: ['AssetDet_Id', 'Asset Code', 'Asset Id', 'Asset Type', 'Brand', 'Model', 'Serial Number', 'Transaction Type', 'Campus', 'Block', 'Location', 'Name', 'Created By', 'Created Date', 'Modified By', 'Modified Date'],
        colModel: [
                      ...
                      { name: 'CurrentBlock', index: 'CurrentBlock',hidden:true },
                      { name: 'CurrentLocation', index: 'CurrentLocation', hidden: true },
        ...
        caption: "<i class='ace-icon fa fa-list'></i>&nbsp;Students Laptop Distribution List",
    })
    ...
    $("#btnSearch").click(function () {
       ...
       {
           datatype: "json",
           url: '/Asset/StudentsLaptopDistributionjqGrid',
           postData: { AssetCode: AssetCode, AssetType: AssetType, Make: Make, Model: Model, SerialNo: SerialNumber, FormId: FormId, TransactionType: TransactionType,IsSubAsset: false },
           page: 1
       }).trigger("reloadGrid");
    });
    ...
    $("#btnReset").click(function () {
        ...
        $(grid_selector).setGridParam(
       {
           datatype: "json",
           url: '/Asset/StudentsLaptopDistributionjqGrid',
           postData: { AssetCode: "", AssetType: "", Make: "", Model: "", SerialNo: "", FormId: "", TransactionType: "" },
           page: 1
       }).trigger("reloadGrid");
    });
    $('#btnAdd').click(function () {
        ...
        if ($('#ddlAssetType').val() == null || $('#ddlAssetType').val() == 'Undefined' || $('#ddlAssetType').val() == "" || $('#ddlAssetType').val() == " ") {
            ...
            ModifiedLoadPopupDynamicaly("/Asset/AddNewDistribution?AssetId=" + $('#ddlAssetType').val(), $('#newDistribution'), function () {
                LoadSetGridParam($('#newDistribution'))
            }, function () { }, 400, 500, "Add Students Laptop");
        }
    });
