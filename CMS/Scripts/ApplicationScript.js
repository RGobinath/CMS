...
function ModifiedLoadPopupDynamicaly(dynURL, ModalId, loadCalBack, onSelcalbck, width, height, title) {
    if (width == undefined) { width = 800; }
    ...
    $.ajax({
        ...
        success: function (data) {
            ModalId.dialog({
                ...
                position: 'absolute',
                modal: true,
                title: "<div class='widget-header' style='align:left; color:#a94442;'><h4 class='smaller'>" + title + "</h4></div>",
                buttons: {},
                open: function (event, ui) {
                    $(".ui-icon-closethick").hide();
                }
