$(function () {
    ...
    var HeaderName = $("#viewbagheadername").val();
    ...
    $(grid_selector).jqGrid({
        url: '/StaffIssues/ShowCallDetailsListJqGrid1?HeaderName=' + HeaderName + '&Result=' + Result + '&Performer=' + Perfomer + '&FromDate=' + FromDate + '&ToDate=' + ToDate + '&Campus=' + Campus + '&IssueGroup=' + IssueGroup + '&IssueType=' + IssueType,
        datatype: 'json',
        mtype: 'GET',
    ...
    if ($("#showexcel").val() == "True") {
        jQuery(grid_selector).jqGrid('navButtonAdd', pager_selector, {
            ...
            onClickButton: function () {
                ...
                window.open("ExportToExcelSIMDR" + '?Performer=' + Perfomer + '&FromDate=' + FromDate + '&ToDate=' + ToDate + '&Result=' + Result + '&HeaderName=' + HeaderName + '&Campus=' + $("#ddlCampus").val() + '&IssueType=' + $("#ddlIssueType").val() + '&IssueGroup=' + $("#ddlIssueGroup").val() + '&rows=9999');
    ...
    jQuery(grid_selector).jqGrid('navButtonAdd', pager_selector, {
        ...
        onClickButton: function () {
            //window.open("ShowCallDetailsListJqGrid1" + '?Performer=' + Perfomer + '&FromDate=' + FromDate + '&ToDate=' + ToDate + '&Result=' + Result + '&HeaderName=' + HeaderName + '&Campus=' + $("#ddlCampus").val() + '&IssueType=' + $("#ddlIssueType").val() + '&IssueGroup=' + $("#ddlIssueGroup").val() + '&rows=9999' + '&ExptXl=1');
            window.open("StaffIssueManagementDateWiseReportPDF" + '?Performer=' + Perfomer + '&FromDate=' + FromDate + '&ToDate=' + ToDate + '&Result=' + Result + '&HeaderName=' + HeaderName + '&Campus=' + $("#ddlCampus").val() + '&IssueType=' + $("#ddlIssueType").val() + '&IssueGroup=' + $("#ddlIssueGroup").val() + '&rows=9999');
            //window.open("ExportToExcel");
        }
    });
