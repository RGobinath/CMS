jQuery(function ($) {
    ...
    jQuery(grid_selector).jqGrid({
        ...
        url: '/HostelManagement/JqgridFoodExpenses/',
        datatype: 'json',
        mtype: 'GET',
        shrinkToFit: true,
        height: 250,
        colNames: ['Id', 'MainID', 'Stud_Id', 'Name', 'NewId', 'Date', 'Amount', 'Venue', 'DummyRec'],
        colModel: [
                { name: 'Id', index: 'Id', width: 230, editable: true, hidden: true },//0
                { name: 'MainID', index: 'MainID', width: 230, editable: true, hidden: true, key: true },//1
                ...
                { name: 'Amount', index: 'Amount', width: 260, editable: true },//6
                { name: 'Venue', index: 'Venue', width: 190, editable: true, edittype: "textarea", editoptions: { cols: 20 } },//7
                { name: 'Date', index: 'Date', editable: true, search: true, hidden: true },//8
                //{ name: 'RowCount', index: 'RowCount', editable: true, search: true, hidden: true }
    ...
    jQuery(grid_selector).jqGrid('navGrid', pager_selector,
            ...
            {}, //Edit
            {
                url: '/HostelManagement/SaveAndEditFoodExpenses',
              ...
              { url: '/HostelManagement/DeleteFoodExpenses/', closeAfterDelete: true, beforeShowForm: function (params) { var gsr = $(grid_selector).getGridParam('selrow'); var sdata = $(grid_selector).getRowData(gsr); return { Id: sdata.Id } } }, //Delete 
              {}, {})
