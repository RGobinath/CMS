jQuery(function ($) {
    ...
    jQuery(grid_selector).jqGrid({
        ...
        url: '/HostelManagement/JqgridChangeRoomAllotment/',
        datatype: 'json',
        mtype: 'GET',
        shrinkToFit: true,
        height: 250,
        colNames: ['Id', 'MDId', 'Stud_Id', 'Name', 'NewId', 'Date Of Incident', 'Details Of Incident', 'Amount', 'Remarks'],
        colModel: [
                ...
                { name: 'Name', index: 'Name', width: 260, editable: true },//3
                { name: 'NewId', index: 'NewId', width: 260, editable: true },//4
                { name: 'DateOfIncident', index: 'DateOfIncident', editable: true },//5
                { name: 'DetailsOfIncident', index: 'DetailsOfIncident', width: 260, editable: true },//6
                { name: 'Amount', index: 'Amount', width: 260, editable: true },//7
                { name: 'Remarks', index: 'Remarks', width: 190, editable: true }//8
        ],
        viewrecords: true,
        rowNum: 20,
