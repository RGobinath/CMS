jQuery(function ($) {
    ...
    jQuery(grid_selector).jqGrid({
        ...
        url: '/HostelManagement/JqgridMedicalExpenses/',
        datatype: 'json',
        mtype: 'GET',
        shrinkToFit: true,
        height: 250,
        colNames: ['Id', 'MainID', 'Stud_Id', 'Name', 'NewId', 'Date Of Illness', 'Amount', 'Remarks', 'DummyRec'],
        colModel: [
                ...
                { name: 'DateOfIllness', index: 'DateOfIllness', editable: true, search: true, hidden: true },//8
    ...
    jQuery(grid_selector).jqGrid('navGrid', pager_selector,
            ...
            {}, //Edit
            {
                url: '/HostelManagement/SaveAndEditMedicalExpenses',
              ...
              { url: '/HostelManagement/DeleteMedicalExpenses/', closeAfterDelete: true, beforeShowForm: function (params) { var gsr = $(grid_selector).getGridParam('selrow'); var sdata = $(grid_selector).getRowData(gsr); return { Id: sdata.Id } } }, //Delete 
              {}, {})
