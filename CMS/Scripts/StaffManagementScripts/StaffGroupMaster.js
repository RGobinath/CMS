...
jQuery(function ($) {
    ...
    jQuery(grid_selector).jqGrid({
        url: '/StaffManagement/StaffGroupMasterJqGrid',
        datatype: 'json',
        height: 200,
        mtype: 'GET',
        colNames: ['StaffGroupId', 'Campus', 'Group Name', 'Is Active', 'Created By', 'Created Date', 'Modified By', 'Modified Date'],
        colModel: [
                      { name: 'StaffGroupId', index: 'StaffGroupId', hidden: true, editable: true, key: true },
                      {
                      ...
                      { name: 'GroupName', index: 'GroupName', editable: true, editrules: { required: true } },
                      { name: 'IsActive', index: 'IsActive', edittype: 'select', editable: true, editoptions: { sopt: ['eq'], value: { '': 'Select', 'true': 'Yes', 'false': 'No' }, style: "width: 149px; height: 20px; font-size: 0.9em" }, editrules: { required: true } },
        ...
        caption: "<i class='ace-icon fa fa-list'></i>&nbsp;Staff Group Master",
    })
    ...
    jQuery(grid_selector).jqGrid('navGrid', pager_selector,
            ...
            {
                width: 'auto', url: '/StaffManagement/EditStaffGroupMaster', modal: false, closeAfterEdit: true
            ...
            {
                width: 'auto', url: '/StaffManagement/AddStaffGroupMaster', modal: false, closeAfterAdd: true
                //url: '/Common/AddAcademicMaster', closeOnEscape: true, beforeShowForm: function (frm)
                //{ $('#FormCode').attr('readonly', 'readonly'); }
            }, //Add
              {
                  width: 'auto', url: '/StaffManagement/DeleteStaffGroupMaster', beforeShowForm: function (params) {
    ...
    $("#btnReset").click(function () {
        ...
        jQuery(grid_selector).setGridParam(
       {
           datatype: "json",
           url: '/StaffManagement/StaffGroupMasterJqGrid',
           postData: { Campus: "", GroupName: "", IsActive: "" },
           page: 1
       }).trigger("reloadGrid");
    });
    $("#btnSearch").click(function () {
        ...
        jQuery(grid_selector).setGridParam(
       {
           datatype: "json",
           url: '/StaffManagement/StaffGroupMasterJqGrid',
           postData: { Campus: Campus, GroupName: GroupName, IsActive: IsActive },
           page: 1
       }).trigger("reloadGrid");
    });
