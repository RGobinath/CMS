$(function () {
    ...
    $(grid_selector).jqGrid({
        url: '/StaffManagement/StaffWiseStudentSurveyReportJqgrid',
        //postData: { Campus: Campus, Grade: Grade, Section: Section, Surveyno: Surveyno, AcademicYear: AcademicYear },
        datatype: 'json',
        height: 230,
        mtype: 'GET',
        colNames: ['Id', 'Academic Year', 'Campus', 'Staff Name', 'Staff PreRegNumber', 'Department', 'CategoryName', 'No. of Students Attended', 'No. of Question in Survey', 'Score', 'Average Score'],
        ...
        subGridRowExpanded: function (StudentSurey, Id) {
            ...
            jQuery("#" + surveystaffListTable).jqGrid({
                url: '/StaffManagement/StudentSurveyStaffwiseReportJqgrid?Id=' + Id + '&Survey=' + $('#ddlSurveyNo').val(),
                datatype: 'json',
                mtype: 'GET',
                colNames: ['Id', 'Academic Year', 'Campus', 'Grade', 'Section', 'Survey Number', 'Survey Date', 'No. of Students Attended', 'No. of Question in Survey', 'Score', 'Average Score'],
                colModel: [{ name: 'Id', index: 'Id', key: true, hidden: true },
                    { name: 'AcademicYear', index: 'AcademicYear', hidden: true },
                    { name: 'Campus', index: 'Campus', hidden: true },
            ...
            jQuery("#" + surveystaffListTable).jqGrid('navButtonAdd', "#" + surveystaffListPager, {
                ...
                onClickButton: function () {
                    window.open("/StaffManagement/StudentSurveyStaffwiseReportJqgrid?ExportType=Excel&Id=" + Id + '&rows=99999');
                }
            });
    ...
    $(grid_selector).jqGrid('navButtonAdd', pager_selector, {
        ...
        onClickButton: function () {
            ...
            window.open("/StaffManagement/StaffWiseStudentSurveyReportJqgrid?ExportType=Excel&Campus=" + Campus + '&Grade=' + Grade + '&Section=' + Section + '&AcademicYear=' + AcademicYear + '&Surveyno=' + Surveyno + '&rows=99999');
        }
    });
    ...
    function Allloadgrid(Campus, Grade, Section, AcademicYear, Surveyno) {
        ...
        $(grid_selector1).jqGrid({
            url: '/StaffManagement/StudentSurveyReportAllJqgrid',
            postData: { Campus: Campus, Grade: Grade, Section: Section, Surveyno: Surveyno, AcademicYear: AcademicYear },
            datatype: 'json',
            height: 230,
            mtype: 'GET',
        ...
        $(grid_selector1).jqGrid('navButtonAdd', pager_selector1, {
            ...
            onClickButton: function () {
                ...
                AcademicYear = $("#ddlSurveyNo1").val();
                Surveyno = $("#ddlSurveyNo").val();
                window.open("/StaffManagement/StudentSurveyReportAllJqgrid?ExportType=Excel&Campus=" + Campus + '&Grade=' + Grade + '&Section=' + Section + '&AcademicYear=' + AcademicYear + '&Surveyno=' + Surveyno + '&rows=99999');
            }
        });
    }
    ...
    $("#btnallSearch").click(function () {
        ...
        if (!isEmptyorNull(AcademicYear) && !isEmptyorNull(Campus) && !isEmptyorNull(Grade) && !isEmptyorNull(Section) && !isEmptyorNull(Surveyno)) {
            ...
            ErrMsg('Please Select Mandatory.');
            return false;
        }
    });
...
function ShowWeightageMarkwithQuestionSec(rowid, aYear, Cam, Gra, Sect, preRegnum, surveyId) {
    $('#SurveyMarkssecListJqgrid').clearGridData();
    ModifiedLoadPopupDynamicaly("/StaffManagement/ShowQuestionMarksWithSection?RowId=" + rowid, $('#SurveyMarkssecList'), function () {
        LoadSetGridParam($('#SurveyMarkssecListJqgrid'), "/StaffManagement/ShowQuestionMarksListJqGrid?acayear=" + aYear + '&cam=' + Cam + '&gra=' + Gra + '&preRegNum=' + preRegnum + '&sect=' + Sect + '&SurveyId=' + surveyId + '&sidx=StudentSurveyQuestionId');
    }, function () { }, 1000, 500, "Staff wise Detailed Report");
}

function ShowQuestionWeightageMarkinStaff(rowid, aYear, Cam, Gra, Sect, preRegnum, surveyId) {
    $('#SurveyMarkswsecListJqgrid').clearGridData();
    ModifiedLoadPopupDynamicaly("/StaffManagement/ShowQuestionMarksInStaff?RowId=" + rowid, $('#SurveyMarksList'), function () {
        LoadSetGridParam($('#SurveyMarkswsecListJqgrid'), "/StaffManagement/ShowQuestionMarksListJqGrid?acayear=" + aYear + '&cam=' + Cam + '&gra=' + Gra + '&preRegNum=' + preRegnum + '&sect=' + Sect + '&SurveyId=' + surveyId);
    }, function () { }, 1000, 500, "Staff wise Detailed Report");
}