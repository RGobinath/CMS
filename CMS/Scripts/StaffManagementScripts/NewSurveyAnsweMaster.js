$(function () {
   SurveyQuestionddl();
    var grid_selector = "#GetJqGridNewsurveyanswerList";
    var pager_selector = "#GetJqGridNewsurveyanswerListPager";
    ...
    jQuery(grid_selector).jqGrid({
        url: '/StaffManagement/GetJqGridNewsurveyanswerList',
        datatype: 'json',
        height: 190,
        mtype: 'GET',
        colNames: ['Survey Answer Id', 'Survey Question', 'Survey Answer', 'Survey Mark', 'Is Positive', 'Is Active', 'Created By', 'Created Date', 'Modified By', 'Modified Date','Show Details'],
        colModel: [
                      ...
                      { name: 'SurveyAnswer', index: 'SurveyAnswer', editable: true, hidden: true, editrules: { required: true }, },
                      {
                          name: 'SurveyMark', index: 'SurveyMark', editable: true, hidden: true, editrules: { required: true }, sorttype: "float", template: "number", edittype: "text", editoptions: {
                              size: 20, maxlengh: 10,
                      ...
                      { name: 'IsPositive', index: 'IsPositive', editable: true, hidden: true, editrules: { required: true }, edittype: "select", editoptions: { sopt: ['eq'], value: { '': '--Select--', 'true': 'Yes', 'false': 'No' }, style: "width: 140px; height: 25px; font-size: 0.9em" }, editrules: { required: true }, sortable: true, stype: 'select' },
                      ...
                      {
                          name: 'Add', index: 'Add', search: false, width: 40,align:'center'
...
//function AddAnswerDetails(SurveyQuestionId) {
//    debugger;
//    LoadPopupDynamicaly("/StaffManagement/AddNewSurveyAnswerMaster?SurveyQuestionId=" + SurveyQuestionId, $('#AddNewSurveyAnswerMasterDetails'),
//        function () {
//            LoadSetGridParam($('#AddNewSurveyAnswerMasterDetails'))
//        },
//    function () { }, 900, 500, "Add New Survey Answer Master");
//}
function AddAnswerDetails(SurveyQuestionId) {
    ModifiedLoadPopupDynamicaly("/StaffManagement/AddNewSurveyAnswerMaster?SurveyQuestionId=" + SurveyQuestionId, $('#AddNewSurveyAnswerMasterDetails'),
                   function () { }, function () { }, 1000, 500, "Add New Survey Answer Master");
}
