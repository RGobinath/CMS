jQuery(function ($) {
    ...
    jQuery(grid_selector).jqGrid({
        mtype: 'GET',
        height: 250,
        url: '/StaffManagement/EmployeeListJqGrid',
        postData: { campus: campus, designation: designation, department: department, stat: stat, appname: appname, idno: idno, type: 'old' },
        datatype: 'json',
        colNames: ['Request No', 'Name', 'Id Number', 'Campus', 'Designation', 'Department', 'Gender', 'Status', 'App PDF', 'Id'],
        colModel: [
              ...
              { name: 'EmploymentApplicationForm', index: 'EmploymentApplicationForm', width: 30, align: 'center', sortable: true },
        ...
        caption: "<i class='ace-icon fa fa-inbox'></i>&nbsp;Employee"
    });
