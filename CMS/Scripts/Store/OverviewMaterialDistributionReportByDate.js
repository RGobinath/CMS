var grid_selector = "#OverviewMaterialDistributionReportByDateList";
var Pager_selector = "#OverviewMaterialDistributionReportByDateListPager";
...
$(function () {
    $(grid_selector).jqGrid({
        url: '/Store/GetMaterialDistributionListReportByDate',
        datatype: 'Json',
        mtype: 'GET',
        colNames: ['Id', 'Academic Year', 'Campus', 'Material', 'IssuedTotal','Date'],
        colModel: [
                    ...
                    { name: 'Material', index: 'Material', sortable: false, editable: false },
                     ...
                     { name: 'Date', index: 'Date', sortable: false, editable: false, stype: false,hidden:true },
        ],
    ...
    $("#search").click(function () {
        ...
        var Date = $("#txtFromCreatedDate").val();
    ...
    $("#reset").click(function () {
        alert();
        var resdate = $("#txtFromCreatedDate").val('');
