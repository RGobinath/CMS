var grid_selector = "#jqGridStudentIssueReportDetailsList";
var Pager_selector = "#jqGridStudentIssueReportDetailsListPager";
...
$(function () {
    $(grid_selector).jqGrid({
        url: '/Store/GetMaterialDistributionListReport_vw',
        datatype: 'Json',
        mtype: 'GET',
        colNames: ['Id', 'Campus', 'Grade', 'MaterialSubGroup', 'Material', 'IssuedTotal'],
        colModel: [
    ...
    searchoptions: {
        ...
        style: "width: 265px; height: 25px; font-size: 0.9em"
                    ...
                    {
                        name: 'Grade', index: 'Grade', sortable: false, editable: false, stype: 'select',
    ...
    jQuery(grid_selector).jqGrid('navButtonAdd', Pager_selector, {
        ...
        onClickButton: function () {
            ...
            window.open("ExportToExcelMaterialDistributionReport" + '?rows=9999'+'&Campus='+Campus+'&Grade='+Grade+'&MaterialSubGroup='+MaterialSubGroup+'&Material='+Material);
