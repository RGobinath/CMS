$(function () {
    ...
    var grid_selector = "#EmpAttendanceDetailsList";
    var pager_selector = "#EmpAttendanceDetailsListPager";
    var Absent = $("#AbsentDate").val();
    ...
    jQuery(grid_selector).jqGrid({
        url: '/Employee/EmployeeAttendanceDetailsListJqGrid',
        datatype: 'json',
        height: 215,
        ...
        caption: "<i class='ace-icon fa fa-user'></i>&nbsp;Employee Attendance"
    ...
    function FillDriverIdNo(EmployeeName) {
        debugger;
        var Campus = $("#Campus").val();
...
function EmployeeAttendance() {
    ...
    if (Campus == '' || EmployeeName == '' || EmployeeIdNo == '' || AbsentDate == '' || AbsentType == 'Select') {
        ErrMsg("Please fill all the mandatory fields.");
        return false;
    }
    ...
    $.ajax({
        type: 'POST',
        url: "/Employee/AddEmployeeAttendance",
        data: {
            Campus: Campus, EmployeeName: EmployeeName, EmployeeIdNo: EmployeeIdNo, AbsentDate: AbsentDate,
            AbsentType: AbsentType
        },
        success: function (data) {
            $("#EmpAttendanceDetailsList").trigger('reloadGrid');
