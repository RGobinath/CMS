jQuery(function ($) {
    var grid_selector = "#jqGridInboxMaster";
    var pager_selector = "#jqGridInboxPager";
    ...
    jQuery(grid_selector).jqGrid({
        ...
        //if any column added need to check formateadorLink
             ...
             { name: 'Description', index: 'Description' },
              { name: 'Status', index: 'Status', width: 40, search: false, align: 'center' },
...
function AdmissionStatus(ActivityId, UserType) {
    debugger;
    ModifiedLoadPopupDynamicaly("/Inbox/AdmissionStatus?Id=" + ActivityId + "&UserType=" + UserType, $('#ActivitiesHistory'),
            function () {
...
function search() {
    ...
    $.ajax({
        ...
        success: function (data) {
            $("#jqGridInboxMaster").trigger('reloadGrid');
