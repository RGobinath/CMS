jQuery(function ($) {
    ...
    jQuery(grid_selector).jqGrid({
        url: '/Common/AcademicMasterjqgrid',
        datatype: 'json',
        height: 250,
        colNames: ['FormId', 'Form Code', 'Academic Year', 'Description','IsActive', 'Created By', 'Created Date', 'Modified By', 'Modified Date'],
        colModel: [
                      { name: 'FormId', index: 'FormId', key: true, width: 130, hidden: true, editable: true },
                      { name: 'FormCode', index: 'FormCode', width: 140, editable: true, search: true },
                      { name: 'AcademicYear', index: 'AcademicYear', width: 160, editable: true, search: true },
                      { name: 'AcademicYeardesc', index: 'AcademicYeardesc', width: 190, editable: true, search: true },
                      ...
                      { name: 'UpdateBy', index: 'UpdateBy', width: 20, hidden: true },
                      { name: 'UpdateDate', index: 'UpdateDate', width: 20, hidden: true }
                     ],
        viewrecords: true,
        rowNum: 10,
        rowList: [10, 20, 30],
