...
namespace TIPS.ServiceContract
{
    ...
    public interface IUserServiceSC
    {
        ...
        [OperationContract]
        long CreateOrUpdateDepartment(Department department);
        [OperationContract]
        Dictionary<long, IList<Department>> GetDepartmentListWithPagingAndCriteria(int? page, int? pageSize, string sortby, string sortType, Dictionary<string, object> criteria);
        [OperationContract]
