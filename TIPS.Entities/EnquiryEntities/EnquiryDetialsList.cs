...
{
    public class EnquiryDetailsList
    {
        ...
        public virtual string CourseTrack { get; set; }
        ...
        public virtual string DocTeleNo { get; set; }
        public virtual string DocName { get; set; }
        public virtual string CaseofAllergies { get; set; }
        public virtual string SpecificIllness { get; set; }
