...
{
    public class VehicleCostDetails_Updated
    {
        ...
        public virtual long KMResetValue { get; set; }
    }
    public class NewVehicleCostDetailsPDF
    {
        public virtual IList<VehicleCostDetails_Updated> VehicleCostDetailsList { get; set; }
    }
}
